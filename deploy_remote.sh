#! /bin/bash
# deploy_remote.sh
ssh -i /secrets/"kp-julie-1.pem" ec2-user@ec2-3-14-133-129.us-east-2.compute.amazonaws.com  -c 'java-version'
ssh -i /secrets/"kp-julie-1.pem" ec2-user@ec2-3-14-133-129.us-east-2.compute.amazonaws.com  -c 'if [[#? != 0]] then sudo amazon-linux-extras install -y java-openjdk11'
